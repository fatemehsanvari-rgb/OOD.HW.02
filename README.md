...
گام چهارم : تحلیل شی گرا
=======
پس از اعمال الگوها، اصول SRP، OCP و PLK بهبود یافتند چون مسئولیت‌ها تفکیک شدند، توسعه بدون تغییر کدهای موجود ممکن شد و وابستگی به جزئیات کاهش یافت. به‌کمک State و Strategy، اصول LSP، ISP و CRP بهتر رعایت شدند زیرا رفتارها قابل جایگزینی‌اند و کلاس‌ها به متدهای غیرضروری وابسته نیستند. در مقابل نقطه ضعف این طراحی، افزایش تعداد کلاس‌ها و پیچیدگی ساختاری است که می‌تواند خوانایی اولیه را کاهش دهد اما نگهداری و توسعه سیستم ساده تر و پایدار تر شده است.
